...
myPP = defaultPP { ppCurrent = xmobarColor "#073642" "#eee8d5"
                 ...
                 , ppVisible = xmobarColor "#073642" "#eee8d5"
                               . wrap " (" ") " . trim
                 , ppUrgent  = xmobarColor "#dc322f" ""
                 , ppSep = " | "
                 , ppWsSep = ""
                 }
myWorkspaces = map (wrap " " " ")
               ["1:www", "2:shell", "3:emacs", "4:org", "5:mail", "6:music", 
                "7:video", "8:pass", "9:nil"]

myManageHook :: ManageHook
myManageHook = composeAll
             [ (className =? "chromium") --> doShift "1:www"
             , (className =? "urxvt") --> doShift "2:shell"
...
main = do
     ...
     xmonad $ defaultConfig 
        ...
        , ((mod4Mask .|. shiftMask, xK_o), raiseMaybe
                                           (spawn "$HOME/code/bin/orgclient -c")
                                           (title =? "Agenda"))
        , ((mod4Mask .|. shiftMask, xK_m), raiseMaybe
